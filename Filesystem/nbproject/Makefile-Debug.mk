...
${OBJECTDIR}/mountfs.o: mountfs.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/mountfs.o mountfs.cpp

${OBJECTDIR}/ByteUtil.o: ByteUtil.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ByteUtil.o ByteUtil.cpp
